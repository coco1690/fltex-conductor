...
//     // console.log('🚗 viajeEnCurso:', JSON.stringify(data))
...
//       `)
//         .eq('conductor_id', conductorId)
//         .in('estado', ['programado', 'abordando', 'en_curso'])  // 👈 solo estos
...
//     console.log('iniciarViaje data:', JSON.stringify(data))
//     console.log('iniciarViaje error:', JSON.stringify(error))

//     if (error) throw error

//     const viajeActualizado = data as unknown as Viaje

//     // Actualizar viajeActivo, viajeEnCurso y la lista viajes
//     set(state => ({
...
//     }))
//   } catch (error: any) {
//     console.log('iniciarViaje catch:', error.message)
//     set({ error: error.message })
//   } finally {
//     set({ cargando: false })
//   }
...
//       console.log('completarViaje error:', error)  // 👈
//       if (error) throw error
//       set({ viajeActivo: null, viajes: [] })
//     } catch (error: any) {
//       console.log('completarViaje catch:', error.message)  // 👈
//       set({ error: error.message })
//     } finally {
//       set({ cargando: false })
//     }
